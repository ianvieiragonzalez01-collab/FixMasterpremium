...
import { Repair, Transaction, User } from '../types';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {isTrial && (
            <Link 
              to="/assinar"
              className="hidden md:flex items-center gap-2 bg-amber-50 text-amber-700 px-4 py-2 rounded-xl font-bold border border-amber-100 hover:bg-amber-100 transition-all"
            >
